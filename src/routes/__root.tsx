...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maya Dimitrova — IT Project Officer, Luxembourg" },
      { name: "description", content: "Editorial profile of Maya Dimitrova, MBA, MMIS, CSM® — IT Project Officer based in Luxembourg. Experience across EU institutions, US higher education and telecom." },
      { name: "author", content: "Maya Dimitrova" },
